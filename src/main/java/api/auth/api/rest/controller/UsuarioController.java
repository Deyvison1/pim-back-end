...
import api.auth.api.domain.entity.Usuario;
import api.auth.api.exception.SenhaInvalidaException;
import api.auth.api.rest.dto.CredenciaisDTO;
import api.auth.api.rest.dto.TokenDTO;
